...
const AgentPerformanceCard = ({ performanceData, loading = false }) => {
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Typography variant="h4" color="warning.main">
                  {formatCurrency(metrics.totalPay || 0)}
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Rate: {formatCurrency(metrics.ratePerSecond || 0)}/second
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item xs={12}>
              <Box sx={{ mt: 2 }}>
                <Stack direction="row" spacing={1} flexWrap="wrap">
                  ...
                  <Chip
                    icon={<MoneyIcon />}
                    label={`${formatCurrency(metrics.totalPay || 0)} Earned`}
                    color="secondary"
                    variant="outlined"
                  />
                </Stack>
