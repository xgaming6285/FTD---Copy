...
const PROXY_CONFIG = {
  ...
  port: 6300,
  password: "TPvBwkO8",
  baseUsername: "34998931", // Just the account username
};
...
async function generateProxyConfig(countryName, countryCode = null) {
  try {
    ...
    // Create username with 922proxy format: USERNAME-region-COUNTRY-sessid-SESSION
    // Use uppercase country code as per 922proxy documentation
    const username = `${
